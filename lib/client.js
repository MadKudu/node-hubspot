...
function Client(opts) {
  ...
  var deals = {
    getRecentyModified: function(options, cb){
      if (typeof options === 'function') {
        cb = options;
        options = {};
      }
    ...
    updateById: function(id, options, cb){
      if(typeof options === 'function'){
        cb = options;
        options = {};
      }
    ...
    associate: function(id, options, cb){
      this.options = options;
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + 'deals/v1/deal/' + id + '/associations/'+ this.options.objectiveType +'?id=' + this.options.id,
        qs: options
      }, cb)
    },
    removeAssociation: function(id, options, cb){
      this.options = options;
      sendRequest({
        method: 'DELET',
        url: self.baseUrl + 'deals/v1/deal/' + id + '/associations/'+ this.options.objectiveType +'?id=' + this.options.id,
