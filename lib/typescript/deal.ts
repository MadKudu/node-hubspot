...
declare class Deal {
  ...
  getAssociated(objectType: string, objectId: number, cb: RequestCallback): RequestPromise;
  getAssociated(objectType: string, objectId: number, opts: {}, cb: RequestCallback): RequestPromise;
